...
import functools
import torch
#from configs import paths_config_anya, global_config # original
from projector.PTI.configs import paths_config_anya, global_config # run_all
from projector.PTI.utils import legacy
...
def load_tuned_G(run_id, type):
    new_G_path = f'{paths_config_anya.checkpoints_dir}/model_{run_id}_{type}.pt'
...
def load_old_G(sampling_multiplier = 2):
    ...
    network_name = paths_config_anya.eg3d_ffhq_pkl.replace('name', global_config.network_name)
