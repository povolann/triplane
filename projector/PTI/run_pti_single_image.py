...
import os
from configs import global_config, paths_config_anya
import glob
import click
...
def run_PTI(run_name, use_wandb, use_multi_id_training, network_name, image_in, latent_space_type):
    ...
    # All paths are saves in paths_config.py file
