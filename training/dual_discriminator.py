...
class SingleDiscriminator(torch.nn.Module):
    def __init__(self,
        ...
        architecture        = 'skip', # Architecture: 'orig', 'skip', 'resnet'. 'resnet' doesn't work with this implementation.
        ...
        disc_c_noise        = None,     # Ignored for SingleDiscriminator
