...
# Chest
python run_all.py --network_pkl ./networks/network-snapshot-004240.pkl --trunc 0.7 --outdir debug/00011-drr-chest_128-gpus1-batch8-projected/inversion --cfg drr --foc 1.5 --image_in chest_psnr --num_steps 3000
python metrics.py --dataset chest --img_dir debug/00011-drr-chest_128-gpus1-batch8-projected/inversion
